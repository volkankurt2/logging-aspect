...
import com.odeal.logging.logger.controller.utils.RequestUtil;
...
public class GenericControllerAspect extends LoggerAspect implements ControllerAspect {
    ...
    @Pointcut("@annotation(com.odeal.logging.logger.controller.annotation.Logging) " +
            "|| @target(com.odeal.logging.logger.controller.annotation.Logging)")
    public void methodOrClassLoggingEnabledPointcut() {
    }

    @Pointcut("!@annotation(com.odeal.logging.logger.controller.annotation.NoLogging)")
    ...
    public Object log(@NotNull ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        try {
            ...
            if (result instanceof ResponseEntity) {
                ...
                logProvider.setStatusCode(String.valueOf(responseEntity.getStatusCode().value()));
            }
    ...
    public void logPreExecutionData(@NotNull ProceedingJoinPoint proceedingJoinPoint, @Nullable RequestMapping methodRequestMapping, InfoLog infoLog) {
        MethodSignature methodSignature = (MethodSignature) proceedingJoinPoint.getSignature();
